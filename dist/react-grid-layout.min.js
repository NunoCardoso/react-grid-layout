!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      "use strict";
      (e.__esModule = !0), (e.createDragApiRef = e.noop = void 0);
      var r =
        Object.assign ||
        function(t) {
          ...
          return (
            a.default.Children.forEach(e, function(e, n) {
              ...
              if (o) i[n] = c(o);
                ...
                a
                  ? (s || j([a], "ReactGridLayout.children"),
                    (i[n] = c(r({}, a, { i: e.key }))))
                  : (i[n] = c({ w: 1, h: 1, x: 0, y: l(i), i: String(e.key) }));
              }
            }),
            (i = f((i = g(i, { cols: n })), o, n))
          );
        }),
        (e.validateLayout = j),
      ...
      function f(t, e, n) {
        for (
          var r = w(t), o = _(t, e), a = Array(t.length), i = 0, s = o.length;
          i < s;
          i++
        ) {
          var u = c(o[i]);
      ...
      function v(t, e) {
        for (var n = 0, r = t.length; n < r; n++) if (p(t[n], e)) return t[n];
      }
      function b(t, e) {
      ...
      function x(t, e, n, r, o, a, i, s) {
        ...
        if (a && p.length)
          return (
            z("Collision prevented on " + e.i + ", reverting."),
            (e.x = u),
            (e.y = l),
            (e.moved = !1),
            t
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (k["[object Float32Array]"] = k["[object Float64Array]"] = k[
          ...
          (k[u] = k[l] = k[j] = k[p] = k[z] = k[f] = k[h] = k[d] = k[g] = k[
            m
          ] = k[b] = k[x] = k[S] = k[_] = k["[object WeakMap]"] = !1);
        var E = "object" == typeof t && t && t.Object === Object && t,
          T = "object" == typeof self && self && self.Object === Object && self,
          P = E || T || Function("return this")(),
          M = e && !e.nodeType && e,
          ...
          return (
            ...
            (null == t || null == e || (!Jt(t) && !Jt(e))
              ...
              : (function(t, e, n, r, o, s) {
                  ...
                  if (!(n & a)) {
                    var C = w && K.call(t, "__wrapped__"),
                      k = O && K.call(e, "__wrapped__");
                    if (C || k) {
                      var E = C ? t.value() : t,
                        T = k ? e.value() : e;
                      return s || (s = new zt()), o(E, T, n, r, s);
                    }
                  }
                  if (!D) return !1;
                  return (
                    ...
                    (function(t, e, n, r, o, i) {
                      ...
                      for (var p = l; p--; ) {
                        var f = u[p];
                        if (!(s ? f in e : K.call(e, f))) return !1;
                      }
                      var h = i.get(t);
                      ...
                      for (var y = s; ++p < l; ) {
                        ...
                        var g = t[f],
                          m = e[f];
                        if (r)
                          var v = s ? r(m, g, f, e, t, i) : r(g, m, f, t, e, i);
        ...
        function Pt(t) {
          return (
            !(!$t(t) || ((e = t), Q && Q in e)) && (Gt(t) ? tt : D).test(qt(t))
          );
          var e;
        }
        function Mt(t) {
        ...
        function Lt(t, e, n, r, o, s) {
          ...
          for (s.set(t, e), s.set(e, t); ++f < l; ) {
            var y = t[f],
              g = e[f];
            if (r) var m = u ? r(g, y, f, e, t, s) : r(y, g, f, t, e, s);
            if (void 0 !== m) {
              if (m) continue;
              h = !1;
              break;
        ...
        (_t.prototype.clear = function() {
          ...
          (_t.prototype.has = function(t) {
            var e = this.__data__;
            return yt ? void 0 !== e[t] : K.call(e, t);
          }),
          ...
          (Rt.prototype.delete = function(t) {
            ...
            return !(
              n < 0 ||
              (n == e.length - 1 ? e.pop() : at.call(e, n, 1), --this.size, 0)
            );
          }),
        ...
        ((ct && It(new ct(new ArrayBuffer(1))) != z) ||
          (pt && It(new pt()) != g) ||
          (ft && "[object Promise]" != It(ft.resolve())) ||
          (ht && It(new ht()) != S) ||
        ...
        var Xt = Et(
            ...
            ? Et
            : function(t) {
                return Jt(t) && K.call(t, "callee") && !ot.call(t, "callee");
              },
          Ft = Array.isArray;
        var Ut =
          ut ||
        ...
        var Kt = A
          ...
          : function(t) {
              return Jt(t) && Vt(t.length) && !!k[kt(t)];
            };
        function Qt(t) {
          return null != (e = t) && Vt(e.length) && !Gt(e) ? Dt(t) : Mt(t);
          var e;
        }
    ...
    function(t, e, n) {
      ...
      var f = (function(t) {
        ...
        return (
            ...
            (this.props.dragApiRef.value = {
              dragIn: function(n) {
                var r = n.i,
                  ...
                  f = n.event,
                  h = n.position;
                e = { i: r, w: o, h: a, node: p };
                var d = t.state.layout,
                  y = t.props,
                  g = y.margin,
                  m = y.containerPadding,
                  v = (0, l.calcXY)(h.top, h.left, {
                    containerWidth: t.props.width,
                    cols: t.props.cols,
                    margin: g,
                    containerPadding: m || g,
                    rowHeight: t.props.rowHeight,
                    maxRows: t.props.maxRows,
                    w: o,
                    h: a
                  }),
                  b = v.x,
                  w = v.y;
                if (t.state.activeDrag)
                  t.onDrag(r, b, w, { e: f, node: p, newPosition: h });
                else {
                  var x = {
                    i: r,
                    w: o,
                  ...
                  t.setState({
                    oldDragItem: x,
                    oldLayout: d,
                    layout: [].concat(t.state.layout, [x]),
                    activeDrag: x
                  }),
                    t.props.onDragStart(d, x, x, null, f, p);
                }
              },
              dragOut: function() {
                if (e) {
              ...
              stop: function(n) {
                ...
                if (e) {
                  var a = e,
                    ...
                    p = t.props,
                    f = p.margin,
                    h = p.containerPadding,
                    d = (0, l.calcXY)(o.top, o.left, {
                      containerWidth: t.props.width,
                      cols: t.props.cols,
                      margin: f,
                      containerPadding: h || f,
                      rowHeight: t.props.rowHeight,
                      maxRows: t.props.maxRows,
                      w: s,
                      h: u
                    ...
                    y = d.x,
                    g = d.y;
                  t.onDragStop(i, y, g, { e: r, node: c, newPosition: o }),
                    (e = null);
                }
              }
            }),
          ...
          (e.prototype.onDrag = function(t, e, n, r) {
            ...
            if (c) {
              var p = { i: t, w: c.w, h: c.h, x: c.x, y: c.y, placeholder: !0 };
              (s = (0, u.moveElement)(
                s,
                c,
                e,
          ...
          (e.prototype.onResize = function(t, e, n, o) {
            ...
            if (d) {
              ...
              this.props.onResize(l, c, d, b, a, i),
                this.setState({
                  layout: (0, u.compact)(l, this.compactType(), f),
                  activeDrag: b
                });
            }
          }),
          (e.prototype.onResizeStop = function(t, e, n, r) {
            ...
            this.props.onResizeStop(s, l, p, null, o, a);
            var f = (0, u.compact)(s, this.compactType(), c),
          ...
          (e.prototype.processGridItem = function(t) {
            if (t && t.key) {
              ...
              var n = this.props,
                ...
                v = Boolean(
                  !e.static && f && (e.isDraggable || null == e.isDraggable)
                ),
                b = Boolean(
      ...
      (f.displayName = "ReactGridLayout"),
        ...
        (f.defaultProps = {
          ...
          preventCollision: !1,
          dragApiRef: (0, u.createDragApiRef)(),
...
*/
                ...
                oneOfType: function(t) {
                  ...
                  return c(function(e, n, r, o, a) {
                    for (var i = 0; i < t.length; i++) {
                      var s = t[i];
                      if (null == s(e, n, r, o, a, h)) return null;
                    }
                    return new l(
              ...
              switch (typeof e) {
                ...
                case "object":
                  ...
                  var a,
                    i = o.call(e);
                  if (o !== e.entries) {
                    for (; !(a = i.next()).done; ) if (!d(a.value)) return !1;
                  } else
                    for (; !(a = i.next()).done; ) {
                      var s = a.value;
                      if (s && !d(s[1])) return !1;
	...
	*/
        ...
        var C = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < z.length; n++) if (D(t, z[n]) in e) return z[n];
            return "";
          })(),
          k = function(t, e) {
            if (!(t instanceof e))
        ...
        function U(t, e, n) {
          var r = t.x,
            ...
            a = "translate(" + r + n + "," + o + n + ")";
          if (e) {
            var i = "" + ("string" == typeof e.x ? e.x : e.x + n),
              s = "" + ("string" == typeof e.y ? e.y : e.y + n);
            a = "translate(" + i + ", " + s + ")" + a;
          }
          return a;
        }
            ...
            function r() {
              ...
              return (
                ...
                (o.handleDragStart = function(e) {
                  ...
                  if (
                    !(
                      ...
                      (o.props.handle && !A(e.target, o.props.handle, n)) ||
                      (o.props.cancel && A(e.target, o.props.cancel, n))
                    )
                  ) {
                    var a = (function(t) {
                ...
                (o.handleDragStop = function(e) {
                  if (o.state.dragging) {
                    var n = Q(e, o.state.touchIdentifier, o);
                    if (null != n) {
                      var r = n.x,
                        a = n.y,
                        i = Z(o, r, a),
                        s = t.findDOMNode(o);
                      s && o.props.enableUserSelectHack && V(s.ownerDocument),
                        o.setState({ dragging: !1, lastX: NaN, lastY: NaN }),
                        o.props.onStop(e, i),
                        s &&
                          (B(s.ownerDocument, rt.move, o.handleDrag),
                          B(s.ownerDocument, rt.stop, o.handleDragStop));
                    }
                  }
                }),
                (o.onMouseDown = function(t) {
                  return (rt = nt.mouse), o.handleDragStart(t);
                }),
                (o.onMouseUp = function(t) {
                  return (rt = nt.mouse), o.handleDragStop(t);
                }),
                (o.onTouchStart = function(t) {
                  return (rt = nt.touch), o.handleDragStart(t);
                }),
                (o.onTouchEnd = function(t) {
                  return (rt = nt.touch), o.handleDragStop(t);
                }),
                L(o, n)
              );
            }
              ...
              E(r, [
                {
                  ...
                  value: function() {
                    ...
                    if (e) {
                      ...
                      B(n, nt.mouse.move, this.handleDrag),
                        B(n, nt.touch.move, this.handleDrag),
                        B(n, nt.mouse.stop, this.handleDragStop),
                        B(n, nt.touch.stop, this.handleDragStop),
          ...
          function r(t) {
            ...
            return (
              (e.onDragStart = function(t, n) {
                var r = e.props.onStart(t, tt(e, n));
                if (!1 === r) return !1;
                ...
                if (e.props.bounds) {
                  ...
                  var s = (function(t, e, n) {
                      ...
                      if ("string" == typeof r) {
                        ...
                        r = {
                          left:
                            -o.offsetLeft + O(l.paddingLeft) + O(u.marginLeft),
                          top: -o.offsetTop + O(l.paddingTop) + O(u.marginTop),
                          right:
                            F(s) -
                            Y(o) -
                            o.offsetLeft +
                      ...
                      return (
                        R(r.right) && (e = Math.min(e, r.right)),
                        R(r.bottom) && (n = Math.min(n, r.bottom)),
                        R(r.left) && (e = Math.max(e, r.left)),
                        R(r.top) && (n = Math.max(n, r.top)),
                        [e, n]
                      );
                    })(e, o.x, o.y),
                    u = N(s, 2),
              ...
              (e.onDragStop = function(t, n) {
                if (!e.state.dragging) return !1;
                var r = e.props.onStop(t, tt(e, n));
                if (!1 === r) return !1;
                var o = { dragging: !1, slackX: 0, slackY: 0 },
                  a = Boolean(e.props.position);
                if (a) {
              ...
              },
              {
                ...
                value: function() {
                  var t,
                    ...
                    o = {},
                    a = null,
                    i = Boolean(this.props.position),
                    s = !i || this.state.dragging,
                    u = this.props.position || this.props.defaultPosition,
                    l = {
                      x: J(this) && s ? this.state.x : u.x,
                      y: K(this) && s ? this.state.y : u.y
                    };
                  this.state.isElementSVG
                    ...
                    : (o = (function(t, e) {
                        var n = U(t, e, "px");
                        return T({}, D("transform", C), n);
                      })(l, this.props.positionOffset));
                  var c = this.props,
                    p = c.defaultClassName,
                    f = c.defaultClassNameDragging,
                    h = c.defaultClassNameDragged,
                    d = e.Children.only(this.props.children),
                    y = x(
                      d.props.className || "",
                      p,
                      (T((t = {}), f, this.state.dragging),
                      T(t, h, this.state.dragged),
                      t)
                    );
        ...
        return (
          (at.displayName = "Draggable"),
          (at.propTypes = P({}, ot.propTypes, {
          ...
          (at.defaultProps = P({}, ot.defaultProps, {
            axis: "both",
            bounds: !1,
          ...
          (e.prototype.resizeHandler = function(t) {
            ...
            return function(n, r) {
              var o = r.node,
                ...
                f = c !== e.state.height;
              if ("onResize" !== t || p || f) {
                var h = e.runConstraints(l, c);
                (l = h[0]), (c = h[1]);
                var d = {};
                if ("onResizeStart" === t) d.resizing = !0;
                else if ("onResizeStop" === t)
                  (d.resizing = !1), (d.slackW = d.slackH = 0);
                else {
    ...
    function(t, e, n) {
      ...
      (t.exports = n(4).default),
        (t.exports.createDragApiRef = r.createDragApiRef),
        (t.exports.utils = r),
        (t.exports.Responsive = n(19).default),
        (t.exports.Responsive.utils = n(9)),
        (t.exports.WidthProvider = n(20).default);
    },
    function(t, e) {
      var n;
      n = (function() {
    ...
    function(t, e, n) {
      ...
      function h(t, e, n) {
        var r = n.margin,
          ...
          p = Math.round((t - r[1]) / (a + r[1]));
        return {
          x: (c = Math.max(Math.min(c, o - i), 0)),
          y: (p = Math.max(Math.min(p, u - s), 0))
        };
      }
      var d = (function(t) {
        function e() {
        ...
        return (
          ...
          (e.prototype.calcWH = function(t) {
            var e = t.height,
              ...
              h = Math.round((e + o[1]) / (s + o[1]));
            return {
              w: (p = Math.max(Math.min(p, i - u), 0)),
              h: (h = Math.max(Math.min(h, a - l), 0))
            };
          }),
          ...
          (e.prototype.mixinResizable = function(t, e) {
            var n = this.props,
              ...
              l = n.maxW,
              c = n.maxH,
              p = this.calcPosition(0, 0, r - a, 0).width,
              f = this.calcPosition(0, 0, i, u),
              h = this.calcPosition(0, 0, l, c),
              d = [f.width, f.height],
              y = [Math.min(h.width, p), Math.min(h.height, 1 / 0)];
            return o.default.createElement(
              s.Resizable,
              {
                width: e.width,
              ...
              if (s) {
                ...
                switch (t) {
                  case "onDragStart":
                    ...
                    (u.left = p.left - c.left + l.scrollLeft),
                      (u.top = p.top - c.top + l.scrollTop),
                ...
                var f = h(u.top, u.left, e.props),
                  d = f.x,
                  y = f.y;
                return s.call(e, e.props.i, d, y, {
                  e: n,
                  node: o,
                  newPosition: u
                });
          ...
          (e.prototype.render = function() {
            var t = this.props,
              ...
              p = this.calcPosition(e, n, a, i, this.state),
              f = o.default.Children.only(this.props.children),
              h = o.default.cloneElement(f, {
    ...
    function(t, e, n) {
      ...
      (t.exports = function() {
        ...
        (t.exports.ResizableBox = n(18).default);
    },
    function(t, e, n) {
      "use strict";
      var r,
    ...
    function(t, e, n) {
        ...
        h = (function(t) {
          function e() {
            ...
            for (var a = arguments.length, i = Array(a), s = 0; s < a; s++)
              i[s] = arguments[s];
            return (
              (n = o = p(this, t.call.apply(t, [this].concat(i)))),
          ...
          return (
            ...
            (e.prototype.onWidthChange = function(t) {
              var e = t.breakpoints,
                ...
                l = (0, u.getColsFromBreakpoint)(a, n);
              if (
                i !== a ||
                ...
                var c = (0, u.findOrGenerateResponsiveLayout)(r, e, a, i, l, o);
      ...
      (h.propTypes = {
        ...
        layouts: function(t, e) {
          if ("[object Object]" !== f(t[e]))
            throw new Error(
              "Layout property must be an object. Received: " + f(t[e])
            );
          ...
          (n = e = (function(e) {
            function n() {
              ...
              for (var o = arguments.length, a = Array(o), s = 0; s < o; s++)
                a[s] = arguments[s];
              return (
                (r = u(this, e.call.apply(e, [this].concat(a)))),
                (t = r),
                (r.state = { width: 1280 }),
                (r.mounted = !1),
