            ...
            (this.props.dragApiRef.value = {
              dragIn: function(n) {
                var r = n.i,
                  ...
                  s = n.event,
                  u = n.position;
                e = { i: r, w: o, h: a, node: i };
                var c = t.state.layout,
                  p = t.props,
                  f = p.margin,
                  h = p.containerPadding,
                  d = (0, l.calcXY)(u.top, u.left, {
                ...
                if (t.state.activeDrag)
                  t.onDrag(r, y, g, { e: s, node: i, newPosition: u });
                else {
                  var m = { i: r, w: o, h: a, x: y, y: g };
                  t.setState({
                    oldDragItem: m,
                    oldLayout: c,
                    layout: [].concat(t.state.layout, [m]),
                    activeDrag: m
                  }),
                    t.props.onDragStart(c, m, m, null, s, i);
                }
              },
              dragOut: function() {
                if (e) {
                ...
                (o.handleDragStart = function(e) {
                  ...
                  if (
                    !(
                      ...
                      (o.props.handle && !H(e.target, o.props.handle, n)) ||
                      (o.props.cancel && H(e.target, o.props.cancel, n))
                    )
                  ) {
                    var a = (function(t) {
